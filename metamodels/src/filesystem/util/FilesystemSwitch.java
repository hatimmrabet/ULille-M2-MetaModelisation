...
public class FilesystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FilesystemPackage.TEXT_FILE: {
			...
			case FilesystemPackage.BINARY_FILE: {
			...
			case FilesystemPackage.SHORTCUT_FILE: {
				ShortcutFile shortcutFile = (ShortcutFile)theEObject;
				T result = caseShortcutFile(shortcutFile);
				if (result == null) result = caseFile(shortcutFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Shortcut File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Shortcut File</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseShortcutFile(ShortcutFile object) {
		return null;
	}
